...
public class RuedaVO {
	...
	public String toString() {
		return "RuedaVO [idRuedas=" + idRuedas + ", marca=" + marca + ", modelo=" + modelo + ", dimensiones="
				+ dimensiones + ", peso=" + peso + ", componente=" + componente + ", estado=" + estado
				+ ", cocheIdCoche=" + cocheIdCoche + ", fecha=" + fecha + ", sesion=" + sesion + "]";
	}
